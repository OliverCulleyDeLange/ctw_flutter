...
Future<int> getPasscodeCounter() async {
  ...
  debugPrint("Passcode counter: $_counter");
  return _counter;
}
...
Future<int> decrementPasscodeCounter() async {
  ...
  debugPrint("Passcode counter decremented to: $_counter");
  return _counter;
}
